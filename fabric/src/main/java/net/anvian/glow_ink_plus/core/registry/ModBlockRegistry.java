...
public class ModBlockRegistry {
    public static void registerBlocks() {
        ...
        //{c}_stained_glass_pane.replace("_", " "))
        ...
        //{c}_glazed_terracotta.replace("_", " "))
