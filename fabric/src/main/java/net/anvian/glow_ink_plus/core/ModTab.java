    ...
    public static void registerTab() {
        ...
        Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, tab, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
                ...
                .displayItems((context, entries) -> {
                    ...
                    // Glowing Banners
                    entries.accept(glowingStack(Items.WHITE_BANNER));
                    entries.accept(glowingStack(Items.ORANGE_BANNER));
                    entries.accept(glowingStack(Items.MAGENTA_BANNER));
                    entries.accept(glowingStack(Items.LIGHT_BLUE_BANNER));
                    entries.accept(glowingStack(Items.YELLOW_BANNER));
                    entries.accept(glowingStack(Items.LIME_BANNER));
                    entries.accept(glowingStack(Items.PINK_BANNER));
                    entries.accept(glowingStack(Items.GRAY_BANNER));
                    entries.accept(glowingStack(Items.LIGHT_GRAY_BANNER));
                    entries.accept(glowingStack(Items.CYAN_BANNER));
                    entries.accept(glowingStack(Items.PURPLE_BANNER));
                    entries.accept(glowingStack(Items.BLUE_BANNER));
                    entries.accept(glowingStack(Items.BROWN_BANNER));
                    entries.accept(glowingStack(Items.GREEN_BANNER));
                    entries.accept(glowingStack(Items.RED_BANNER));
                    entries.accept(glowingStack(Items.BLACK_BANNER));
                })
                .build()
        );
    }
